...
async def seed_all_data():
    ...
    departamentos = [
        {"nombre": "Física", "desc": "Departamento de Física"},
        {"nombre": "Matemática", "desc": "Departamento de Matemática"},
        {"nombre": "Economía Cuantitativa", "desc": "Departamento de Economía Cuantitativa"},
        {"nombre": "Biología", "desc": "Departamento de Biología"},
        {"nombre": "Civil y Ambiental", "desc": "Departamento de Civil y Ambiental"},
        {"nombre": "Automatización y Control Industrial", "desc": "Departamento de Automatización y Control Industrial"},
        {"nombre": "Electrónica, Telecomunicaciones y Redes de la Información", "desc": "Departamento de Electrónica, Telecomunicaciones y Redes de la Información"},
        {"nombre": "Energía Eléctrica", "desc": "Departamento de Energía Eléctrica"},
        {"nombre": "Geología", "desc": "Departamento de Geología"},
        {"nombre": "Petróleos", "desc": "Departamento de Petróleos"},
        {"nombre": "Ciencias Nucleares", "desc": "Departamento de Ciencias Nucleares"},
        {"nombre": "Ciencias de Alimentos y Biotecnología", "desc": "Departamento de Ciencias de Alimentos y Biotecnología"},
        {"nombre": "Ingeniería Química", "desc": "Departamento de Ingeniería Química"},
        {"nombre": "Metalurgia Extractiva", "desc": "Departamento de Metalurgia Extractiva"},
        {"nombre": "Informática y ciencias de la computación", "desc": "Departamento de Informática y ciencias de la computación"},
        {"nombre": "Ciencias Administrativas", "desc": "Departamento de Ciencias Administrativas"},
        {"nombre": "Estudios organizacionales y desarrollo humano", "desc": "Departamento de Estudios organizacionales y desarrollo humano"},
        {"nombre": "Ingeniería Mecánica", "desc": "Departamento de Ingeniería Mecánica"},
        {"nombre": "Materiales", "desc": "Departamento de Materiales"},
        {"nombre": "Ciencias Sociales", "desc": "Departamento de Ciencias Sociales"},
        {"nombre": "Formación Básica", "desc": "Departamento de Formación Básica"},
        {"nombre": "Escuela de Formación de Tecnólogos", "desc": "Escuela de Formación de Tecnólogos"},
    ]
